...
public class Levels4 extends AppCompatActivity {
    ...
    private int level;
    private String mazeType = "advancedKruskal";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_levels4);
        ...
        String message = getResources().getString(R.string.instructionsEdge);
        ...
        fullScreen.setOnTouchListener(new OnSwipeTouchListener(this) {
            ...
            public void onSwipeRight() {
                Intent nextActivity = new Intent(Levels4.this, Levels3.class);
            ...
            public void onSwipeLeft() {
                Intent nextActivity = new Intent(Levels4.this, Levels1.class);
                startActivity(nextActivity);
                finish();
